...
Route::get('/Todo/{category_id}', 'TodoController@getByCategoryId')->where('category_id', '[0-9]+');
...
Route::get('Todo/edit/{id}','TodoController@put')->where('id', '[0-9]+');;
Route::post('Todo/edit/{id}','TodoController@putSave');
